...
def main():
    ...
    plt.tight_layout()
    fig_path = PROJECT_ROOT / "paper" / "figures" / "alignment_overview.png"
    ...
    fig2, axes2 = plt.subplots(1, 4, figsize=(20, 6.8), sharey=True)
    ...
    fig2_path = PROJECT_ROOT / "paper" / "figures" / "alignment_by_dataset.png"
